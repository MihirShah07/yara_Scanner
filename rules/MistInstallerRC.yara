/*
   ...
   Date: 2025-05-14
   Identifier: tmpxyzrizqo
   Reference: https://github.com/Neo23x0/yarGen
*/

/* Rule Set ----------------------------------------------------------------- */

rule MistInstallerRC {
   meta:
      description = "tmpxyzrizqo - file MistInstallerRC.exe"
      author = "HTB-AC-1135606"
      reference = "https://github.com/Neo23x0/yarGen"
      date = "2025-05-14"
      hash1 = "95d5594cac9cfa5826e1c0b12fec980ff8a01136364aed2831164b46cbb13ca1"
   strings:
      ...
      $s11 = "MistDriver!DriverEntry: FltRegisterFilter failed with code 0x%x" fullword ascii /* score: '10.00'*/
      $s12 = "MistDriver!DriverEntry: ZwWriteFile1 failed with code 0x%x" fullword ascii /* score: '10.00'*/
      $s13 = "MistDriver!DriverEntry: FltStartFiltering failed with code 0x%x" fullword ascii /* score: '10.00'*/
      $s14 = "MistDriver!OnFilterUnload: Driver unloaded" fullword ascii /* score: '10.00'*/
      $s15 = "MistDriver!DriverEntry: ZwWriteFile2 failed with code 0x%x" fullword ascii /* score: '10.00'*/
      $s16 = "MistDriver!DriverEntry: ZwCreateFile failed with code 0x%x" fullword ascii /* score: '10.00'*/
